        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-16 mb-16">
          ...
          <div>
            <h4 className="font-heading font-bold text-lg mb-6 text-white flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-accent-500"></div> Tautan Cepat
            </h4>
            <ul className="flex flex-col gap-4 font-medium">
              ...
              <li>
                <Link href="/login" className="text-accent-500 hover:text-[#f5b030] font-bold transition-colors flex items-center gap-2 group mt-2 bg-white/5 w-fit px-4 py-2 rounded-lg border border-white/10 hover:border-white/20">
                  Portal Admin <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            <h4 className="font-heading font-bold text-lg mb-6 text-white flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-accent-500"></div> Pusat Bantuan
            </h4>
