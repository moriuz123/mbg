...
export default function AdminDinasDashboard({ stats }: AdminDinasDashboardProps) {
  ...
  return (
    <div className="animate-fade-in space-y-6 max-w-7xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 rounded-3xl p-8 lg:p-10 text-white shadow-xl shadow-primary-900/20 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-3xl lg:text-4xl font-black mb-3 tracking-tight">Sistem Digitalisasi Supply Chain Pemkab Lebak</h1>
          <p className="text-primary-100 max-w-2xl text-base lg:text-lg mb-8 leading-relaxed">
          ...
          <div className="flex flex-wrap gap-4">
            <Link 
              href="/admin/sppg" 
              className="inline-flex items-center gap-2 px-6 py-3 bg-white text-primary-800 rounded-xl font-bold hover:bg-slate-50 transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5"
            >
              <Utensils size={18} /> Kelola SPPG
            </Link>
            <Link 
              href="/admin/master-data/sekolah" 
              className="inline-flex items-center gap-2 px-6 py-3 bg-primary-700/50 backdrop-blur border border-primary-500/50 text-white rounded-xl font-bold hover:bg-primary-700 transition-all shadow-md hover:-translate-y-0.5"
            >
              <GraduationCap size={18} /> Data Sekolah
            </Link>
            <Link 
              href="/admin/manajemen-user" 
              className="inline-flex items-center gap-2 px-6 py-3 bg-primary-800/40 backdrop-blur border border-primary-400/30 text-white rounded-xl font-bold hover:bg-primary-800/70 transition-all shadow-md hover:-translate-y-0.5"
            >
      ...
      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 flex flex-col shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <div className="text-sm font-medium text-slate-500 mt-1">Total siswa L/P terdaftar</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 flex flex-col shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <div className="text-sm font-medium text-slate-500 mt-1">Titik dapur produksi MBG</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 flex flex-col shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <div className="text-sm font-medium text-slate-500 mt-1">Sekolah aktif terlayani</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-rose-200 p-6 flex flex-col shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group bg-gradient-to-b from-white to-rose-50/30">
          ...
          <div className="relative z-10">
            ...
            <div className="text-sm font-medium text-rose-500/80 mt-1">Dalam antrean pemetaan</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 flex flex-col shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-4 text-fuchsia-600 font-bold text-sm">
              <div className="p-2.5 bg-fuchsia-100 rounded-xl"><Building2 size={20} /></div>
              Posyandu Tercover
            </div>
            <div className="flex items-baseline gap-2">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 flex flex-col shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <div className="text-sm font-medium text-slate-500 mt-1">Mitra penyedia beras</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 flex flex-col shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <div className="text-sm font-medium text-slate-500 mt-1">Mitra pangan & bahan baku</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
            <div>
              <h2 className="text-lg font-bold text-slate-800">Top SPPG Melayani Siswa Terbanyak</h2>
              <p className="text-xs text-slate-500 mt-0.5">Dapur dengan beban distribusi terbesar saat ini</p>
            </div>
            <Link href="/admin/sppg" className="text-xs font-bold text-primary-600 hover:text-primary-800 transition-colors">
              Lihat Semua SPPG →
            </Link>
          </div>
        ...
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border border-slate-800 shadow-xl p-8 flex flex-col justify-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <Link 
              ...
              className="inline-flex items-center gap-2 text-sm font-bold text-primary-300 hover:text-white transition-colors"
            >
