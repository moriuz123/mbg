...
graph TD
    ...
    %% ==========================================
    subgraph HULU ["🌾 1. RANTAI PASOK & LOGISTIK BAHAN SEGAR"]
    ...
    %% ==========================================
    %% QUALITY CONTROL & UJI RAPID TEST
    %% ==========================================
    subgraph QC ["🔬 2. QUALITY CONTROL & FOOD SAFETY (RAPID TEST)"]
        C1 -->|Sampel Bahan Segar Masuk| D1{"Pemeriksaan Uji Rapid Test"}
        D1 -->|Formalin, Boraks, E.Coli, Pestisida| D2["Master Parameter Uji"]
    ...
    subgraph DAPUR ["🍳 3. PENGOLAHAN STANDAR MENU GIZI"]
        ...
        F1 -->|Chef BNSP & Penjamah Makanan| F2["Proses Memasak Harian"]
    ...
    %% ==========================================
    subgraph VERIFIKASI ["✅ 5. VERIFIKASI DUA ARAH (DITERIMA & CEK MUTU)"]
        H1 -->|Cek Jumlah & Kondisi Makanan| I1["Form Verifikasi Digital Sekolah"]
        H2 -->|Cek Jumlah & Kondisi Makanan| I2["Form Verifikasi Digital Posyandu"]
    ...
    %% ==========================================
    %% UMPAN BALIK & LAYANAN PENGADUAN
    %% ==========================================
    subgraph ADUAN ["📣 6. KANAL ADUAN & ASPIRASI PUBLIK"]
        ...
        DB_ADUAN --> L1["Dashboard Monitoring Admin Dinas Gizi & Operator SPPG"]
        L1 -->|Tindak Lanjut & Evaluasi| C1
    end
```
